window.addEventListener('load',function(){
    ...
    class Particle{
        ...
        draw(context){
            context.drawImage(this.image, this.frameX * this.spriteSize, this.frameY 
                * this.spriteSize, this.spriteSize,this.spriteSize, this.x, this.y, this.size, this.size);
        }
    ...
    class UI{
        ...
        draw(context){
            ...
            context.fillText('Timer: ' + formattedTime,20, 100);            //game over messeges
    ...
    class Game {
        ...
        update(deltaTime){
            ...
            this.particales = this.particales.filter(particale => !particale.
                markedForDeletion);
            this.enemies.forEach(enemy =>{
                ...
                if(this.checkCollision(this.player, enemy)){
                    ...
                    for (let i = 0; i < 10; i++){
                        this.particales.push(new Particle(this,enemy.x
